...
public class testTinhSoGioDiMuonVeSomWhiteBox {
    ...
    public void testcase_1() throws Exception {
        serviceTaoBangBaoCaoNVVP.soGioDiMuonVeSomTrongBuoi("Sang",LocalTime.of(13, 0), LocalTime.of(17, 0));
    }

    @Test(expected = Exception.class)
    public void testcase_2() throws Exception {
        assertEquals(0,
                serviceTaoBangBaoCaoNVVP.soGioDiMuonVeSomTrongBuoi("Chieu", LocalTime.of(7, 0), LocalTime.of(12, 15)),
                1e-5);
    }
    ...
    public void testcase_3() throws Exception {
        assertEquals(0,
                serviceTaoBangBaoCaoNVVP.soGioDiMuonVeSomTrongBuoi("Morning", LocalTime.of(7, 45), LocalTime.of(11, 30)),
                1e-5);
    }
    ...
    public void testcase_6() throws Exception {
        assertEquals(0,
                serviceTaoBangBaoCaoNVVP.soGioDiMuonVeSomTrongBuoi("Chieu", LocalTime.of(12, 45), LocalTime.of(17, 15)),
                1e-5);
    }
}
